...
ENTRYPOINT ["/bin/sh", "-c"]
CMD ["tensorflow_model_server --port=8500 --rest_api_port=${PORT:-8501} --model_name=${MODEL_NAME} --model_base_path=/models/${MODEL_NAME} --monitoring_config_file=/models/monitoring/prometheus.config"]
